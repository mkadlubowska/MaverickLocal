...
with open('seqs_with_2_near_perfect_fwd_primers') as f:
...
with open('seqs_with_2_near_perfect_fwd_primers.extracted.fasta', 'w') as f:
	for line in lines:
...
with  open('umi_dict.pkl', 'wb') as f:
